...
export default function TransactionsPage() {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", `shahriar_finance_ledger_${new Date().toISOString().substring(0, 10)}.csv`);
  ...
  const handleExportPDF = () => {
    ...
    printWindow.document.write(`
      <html><head><title>Shahriar Finance Ledger</title>
      ...
      <body><h1>Shahriar Finance Ledger Report</h1><h3 style="color:#666;font-weight:normal">Generated ${new Date().toLocaleDateString("en-GB")}</h3>
